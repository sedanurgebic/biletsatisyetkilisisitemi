<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yolcuyonet.aspx.cs" Inherits="ucak_web.yolcuyonet" %>
            ...
            <table border="1">
                ...
                <tbody>
                    <asp:Repeater ID="rptliste" runat="server"><ItemTemplate> <tr>
                       ...
                       <td><a href='<%# Eval("ID","yolcuguncelle.aspx?ID={0}") %>'>Düzenle</a></td>
                       <td><a href='<%# Eval("ID","yolcusil.aspx?ID={0}") %>'>Sil</a></td>
